...
\begin{center}
  \begin{tabular}{|c|c|c||c|l|}
    ...
    \hline
    $x$  & $y$  & NP   & NP   & \\
    NP   & NP   & $z$  & $\nicefrac{z}{2}$  & pass $\iff z = 10$ \\
    \hline
    0.0  & 0.0  & 0.0  & 0.0  & fail \\
    5.0  & 5.0  & 5.0  & 5.0  & pass \\
    10.0 & 10.0 & 10.0 & 10.0 & pass \\
    \hline
    0.0  & 0.0  & 10.0 & 5.0  & pass \\
    0.0  & 0.0  & 9.9  & 5.0  & pass (owing to round-off error)\\
    0.0  & 0.0  & 9.8  & 4.9  & fail \\
    \hline
...
overall grade. Class and lab attendance or answers to exercises
are not required to pass and they will not affect the student's overall grade.
Also there are no projects to submit in this course.
...
to avoid getting an score of ``NP'' in that exam and attendance to the final
