...
\end{blackboard}
\includegraphics[width=8cm]{../../lecture-notes/latex/img/tree1/tree1d.eps}
\columnbreak
\begin{blackboard}
class TNode<E> {
    E datum;
...
\end{blackboard}
\includegraphics[width=8cm]{../../lecture-notes/latex/img/tree2/tree2d.eps}
\end{multicols}
...
\begin{minipage}{0.6\linewidth}
  \begin{center}
\includegraphics[width=11cm]{../../lecture-notes/latex/img/linkedbnode/linkedbnode5.eps}
\begin{multicols}{2}
\begin{blackboard}
      PRE_ORDER
