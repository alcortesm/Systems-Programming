...
\begin{multicols}{2}
\VerbatimInput[numbers=left, numbersep=2pt, frame=single]{../java/MagicNumbers.java}
\columnbreak
\VerbatimInput[numbers=left, numbersep=2pt, frame=single]{../java/NoMagicNumbers.java}
\end{multicols}
